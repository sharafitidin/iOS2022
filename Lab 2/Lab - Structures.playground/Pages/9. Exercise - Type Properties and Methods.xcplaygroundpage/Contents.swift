...
struct User {
    ...
    static var currentUser = User(userName: "Shara", email: "Shara228@gmail.com", age: 19)
...
var myUser = User(userName: "Aiba", email: "Aiba@mail.ru", age: 20)
User.currentUser = myUser
print(User.currentUser)

var secondUser = User(userName: "Diana", email: "Diana@mail.ru", age: 19)
