...
var walkingChallenges:[String] = ["Walk 3 miles a day", "Walk 1000 steps"]
var runningChallenges:[String] = ["Run 5 times a week", "Run for 5 km"]
...
if !arr.isEmpty{
    if arr.count == 1{
        print("The challenge you have chosen is \(arr[0])")
    } else{
        print("You have chosen multiple challenges")
    }
} else{
    print("List is empty. Would you want to commit something?")
}
